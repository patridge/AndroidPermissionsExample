...
namespace SpikeAndroidPermissionsAppCompat
{
    [Activity(Label = "Awesome Camera (AppCompat)", MainLauncher = true, Icon = "@mipmap/icon", Theme = "@style/Theme.AppCompat")]
    public class MainActivity : AppCompatActivity
    {
        ...
        {
            // No need for an SDK version check using ActivityCompat.CheckSelfPermission. For <23, installation _is_ permission, and the compat system will return Permission.Granted in a single check.
            ...
            if (ActivityCompat.ShouldShowRequestPermissionRationale(this, Manifest.Permission.Camera))
            {
                ...
                ShowCameraPermissionRationale(
                    () => {
                        ...
                        ActivityCompat.RequestPermissions(this, new[] { Manifest.Permission.Camera }, ButtonClickCameraPermissionRequestCode);
                    },
                    () => {
